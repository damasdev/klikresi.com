<svelte:head>
	...
	<meta
		content="Klik Resi menghargai privasi Anda dan berkomitmen untuk melindungi informasi pribadi Anda."
		name="description"
	/>
</svelte:head>
...
<section class="py-10 md:py-20 scroll-mt-28">
	<div class="container mx-auto px-6">
		<div class="border rounded-lg p-10 md:p-20">
			...
			<p class="mb-2">
				Klik Resi menghargai privasi Anda dan berkomitmen untuk melindungi informasi pribadi Anda.
				Kebijakan Privasi ini menjelaskan bagaimana kami mengumpulkan, menggunakan, mengungkap, dan
				melindungi informasi yang Anda berikan saat Anda mengunjungi situs web kami, menggunakan
				layanan kami, atau berinteraksi dengan kami secara online atau offline. Dengan mengakses
			...
			<ul class="list-disc ml-5 mb-2">
				...
				<li class="list-item">
					Melakukan analisis data dan penelitian untuk meningkatkan produk dan layanan kami.
				</li>
			...
			<p class="mb-2">
				...
				diberitahukan kepada Anda melalui pemberitahuan di situs web atau melalui email. Anda
