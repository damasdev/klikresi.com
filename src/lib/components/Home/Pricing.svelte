<script lang="ts">
	const features = [
		...
		'Kamu bisa lacak hingga 100 paket setiap harinya'
	]
</script>
	...
	<div class="mx-auto container px-6">
		...
		<div class="mt-10 md:mt-16 rounded-3xl ring-1 ring-gray-200 lg:mx-0 lg:flex">
			<div class="p-8 sm:p-10 lg:flex-auto">
				<h3 class="text-2xl font-bold tracking-tight text-gray-900">Tracking API - LITE</h3>
				...
				>
					<div class="mx-auto px-8">
						...
						<p class="mt-6 flex items-baseline justify-center gap-x-2">
							<span class="text-4xl md:text-5xl font-bold tracking-tight text-gray-900">
								Rp 97.000
							</span>
						</p>
						<a
							target="_blank"
							href="https://invoice.xendit.co/od/klikresi-lite"
