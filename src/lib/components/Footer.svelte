...
<footer class="py-20 bg-black text-white">
	<div class="container mx-auto flex flex-col md:flex-row justify-between space-y-10 md:space-y-0 md:space-x-14 px-6">
...
<div class="border-t-[1px] border-gray-700 py-4 bg-black text-white">
	<div class="container mx-auto px-6">
		<p>Copyright 2023 © Klik Resi. All rights reserved. <span class="hidden md:inline">Various trademarks held by their respective owners.</span></p>
	</div>
</div>
